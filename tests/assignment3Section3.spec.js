...
test("sandbox banner is shown when 6 events are returned", async ({ browser, page }) => {
  console.log("--------- Assisgnment 3 Section 3 ---------");
...
test('Test2 sandbox banner is hidden when 4 events are returned', async ({ page }) => {
